...
import { recommendMock } from '../utils/recommend'
...
export default function Recommendation(){
  ...
  async function handleSubmit(e:any){
    e.preventDefault()
    const res = recommendMock({ photo_url: photo || 'https://placehold.co/300', event_type: eventType, hair_length: hairLength, maintenance })
    setResults(res.styles || [])
    setNotes((res.audit_notes || []).filter(Boolean) as string[] )
  }
